...
export async function registerRoutes(app: FastifyInstance) {
  ...
  await app.register(async (api) => {
    const routes = [
      ...
      { path: './modules/health/health.routes', prefix: '', name: 'healthRoutes' },
      { path: './modules/vaccination/vaccination.routes', prefix: '', name: 'vaccinationRoutes' },
      { path: './modules/pregnancy/pregnancy.routes', prefix: '', name: 'pregnancyRoutes' },
      { path: './modules/schedules/schedules.routes', prefix: '', name: 'schedulesRoutes' },
