...
export async function tipsRoutes(app: FastifyInstance) {
  ...
  app.get('/', { preHandler: [requireAuth, requireRole('support')] }, async (request, reply) => {
  ...
  app.get('/:id', { preHandler: [requireAuth, requireRole('support')] }, async (request, reply) => {
  ...
  app.post('/', { preHandler: [requireAuth, requireRole('moderator')] }, async (request, reply) => {
  ...
  app.put('/:id', { preHandler: [requireAuth, requireRole('moderator')] }, async (request, reply) => {
    const { id } = request.params as { id: string };
